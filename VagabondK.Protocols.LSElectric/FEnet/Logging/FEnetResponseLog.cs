...
namespace VagabondK.Protocols.Logging
{
    ...
    /// </summary>
    public class FEnetResponseLog : ChannelResponseLog
    {
        /// <summary>
        /// 생성자
        /// </summary>
        ...
        public FEnetResponseLog(IChannel channel, FEnetResponse response, byte[] rawMessage, FEnetRequestLog requestLog) : base(channel, response, rawMessage, requestLog)
        {
        ...
        /// FEnet 응답 메시지
        /// </summary>
        public FEnetResponse FEnetResponse { get; }
        ...
        {
            var stringBuilder = new StringBuilder("ACK: ");
