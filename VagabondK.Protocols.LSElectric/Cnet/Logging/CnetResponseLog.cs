...
namespace VagabondK.Protocols.Logging
{
    ...
    public class CnetResponseLog : ChannelResponseLog
    {
        ...
        /// <param name="message">Cnet 응답 메시지</param>
        /// <param name="rawMessage">원본 메시지</param>
        /// <param name="requestLog">관련 요청 메시지에 대한 Log</param>
        public CnetResponseLog(IChannel channel, CnetResponse message, byte[] rawMessage, CnetRequestLog requestLog) : base(channel, message, rawMessage, requestLog)
        {
            Message = message;
        }
        ...
        /// Cnet 응답 메시지
        /// </summary>
        public new CnetResponse Message { get; }
